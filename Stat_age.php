...
if(! $ResultSet) 
	...
	{
	echo "<h1>Statistique: age moyen des patients soignes avec un medicament</h1> <br>";
	echo "<h2> Choisissez le medicament: </h2>";
	echo "<FORM method='POST' ACTION ='Statistique_age.php'>";
